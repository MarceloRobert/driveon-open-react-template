        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
                {/* Logo */}
                <Link href="/" className="inline-block mb-2" aria-label="Cruip">
              ...
              <div className="text-gray-400">DriveOn é uma startup desenvolvida na Universidade Federal de Itajubá em vista da disciplina Gestão de Produtos Digitais ministrada pelo docente Adler Diniz.</div>
            </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <div className="text-gray-400 text-sm mr-4">
              Feito por Marcelo Robert & Luan Munholi.<br></br>
              Criado utilizando <a className="text-gray-300 underline" href="https://open.cruip.com/">Open React Template</a> &copy; cruip.com
            </div>
