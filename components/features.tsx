        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Peça caronas</h4>
              <p className="text-lg text-gray-400 text-center">Se você quer viajar mas não há quem levar, escolha o destino e peça sua carona.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Ofereça caronas</h4>
              <p className="text-lg text-gray-400 text-center">Se você for um motorista e quiser ter um ganho extra, pode oferecer caronas aos passageiros de forma simples e fácil.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="300" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Saiba com quem vai</h4>
              <p className="text-lg text-gray-400 text-center">Você pode avaliar o motorista e também o passageiro, sabendo seus gostos e preferências.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Saiba onde há mais caronas</h4>
              <p className="text-lg text-gray-400 text-center">Através do mapa, você pode ver onde pessoas estão oferecendo e solicitando mais caronas.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="500" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Vá para eventos</h4>
              <p className="text-lg text-gray-400 text-center">Sempre que houver um evento relevante perto de você, nosso app irá te avisar, para você não perder nenhuma chance.</p>
            </div>
